...
<html lang="en">
	...
	<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
		...
		<div class="card">
			<h1>Picture This continues international expansion in South Africa</h1>
			<br><br>
			<img src="images/johan.jpg" class="img-responsive center-block">
			<br><br>
			<p>
		...
		<div class="card">
			...
			<img src="images/displaycabinet.jpg" class="img-responsive center-block"> 
			<br><br>
			<img src="images/stone.jpg" class="img-responsive center-block">
			<br><br>
		</div>
		
		<div class="card">
			<h1>PICTURE THIS LONDON MAKES LIFESTYLE HOME SHOW DEBUT</h1>
			<br><br>
			<p>
		...
		<div class="card">
			<h1>Cristian Arostegui set to make IDS Toronto debut with inventive new design</h1>
			<br><br>
			<img src="images/cris3.jpg" class="img-responsive center-block">
			<br><br>
			<p>
			...
			<img src="images/cris1.jpg" class="img-responsive center-block">
			<br><br>
			<p>
		...
		<div class="card">
			<h1>Victoria’s Ann Makosinski makes Forbes 30 Under 30</h1>
			<br><br>
			<img src="images/hsm.jpg" class="img-responsive center-block">
			<br><br>
			<p>
		...
		<div class="card">
			<h1>Canada tops New York Times’ list of “52 Places to Go in 2017”</h1>
			<br><br>
			<img src="images/holdingcanada.jpg" class="img-responsive center-block">
			<br><br>
			<p>
		...
		<div class="card">
			<h1>B.C. gets new interest-free loan for first-time homebuyers</h1>
			<br><br>
			<img src="images/christyclark.jpeg" class="img-responsive center-block">
			<br><br>
			<p>
		...
		<div class="card">
			<h1>HTC Vive’s Alvin Wang Graylin Predicts VR Outlook for 2016 and 2017</h1>
			<br><br>
			<img src="images/maxresdefault.jpg" class="img-responsive center-block">
			<br><br>
			<p>
		...
		<div class="card">
			<h1>Video: Picture This Toronto’s Richard Hillier shares trade show experience</h1>
			<br><br>
			<img src="images/rod.jpg" class="img-responsive center-block">
			<br><br>
			<p>
			...
			<div style="dispay:block;margin:auto;">
				<iframe src="https://www.youtube.com/embed/rc3YLZRJZCs?ecver=2" frameborder="0" style="dispay:block;margin:auto;" allowfullscreen></iframe>
				<br><br>
		...
		<div class="card">
			<h1>How Your Vancouver Dream Home Might Actually Be Obtainable In 2017</h1>
			<br><br>
			<img src="images/livingin.jpg" class="img-responsive center-block">
			<br><br>
			<p>
