			...
			<div class="container" style="width: 100%;">
				<div class="row">
					<div class="col-lg-12 nopadding">
						...
						<h1>Duygu Ates</h1>
						<h1>Owner, Picture This Istanbul</h1>
						<p class="ptt_about22">
							Duygu Ates is a project manager who has been working professionally in different international companies since 2004.
							<br><br>
							Ates has a Bachelor’s degree in Industrial Engineering from Marmara University in Istanbul. She has been PMP certified by PMI since 2013 and has 12 years of project management experience in international business.
							<br><br>
							Duygu Ates is a project manager working professionally in international companies since 2004. She has graduated from Marmara University with bachelor degree in 'Industrial Engineering'. She has been PMP, certified by PMI since 2013 and honored by being mom for 2 kids: a girl and a boy.
							<br><br>
							Having twelve years in project management experience in international business, now she is intended to initiate this intuitive and interactive tool in Turkey.
							<br><br>
						</p>
					</div>
				</div>
				...
				<div class="row nopadding" >
					<div class="col-lg-12 nopadding" >
						<p class="ptt_about" style="padding-bottom:80px;padding-top:80px;">
							Picture This Istanbul is committed to providing a superior product,
