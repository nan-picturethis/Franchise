                        ...
                        <div class="col-md-3 col-sm-3">
                            <div class="form-group">
                                ...
                                <select class="form-control selectpicker" name="category" id="category">
                                    ...
                                    <option value="1">Neighbourhoods</option>
                                    <option value="2">Schools</option>
                                    <option value="3">Transit Routes</option>
                                    <option value="4">Parks</option>
                                    <option value="5">Restaurants/Coffee shops</option>
                                    <option value="6">Hospitals</option>
                                    <option value="7">Grocery Stores</option>
                                    <option value="8">Point of Interest</option>
                                    <option value="9">Gas Stations</option>
                                    <option value="10">Atm</option>
                                    <option value="11">Pharmacies</option>
                                    <option value="12">Hotels</option>
                                    <option value="13">Bars</option>
                                    <option value="14">Post Office</option>
