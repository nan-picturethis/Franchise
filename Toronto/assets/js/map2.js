    ...
    if( document.getElementById(element) != null ){
        ...
        if( optimizedDatabaseLoading == 1 ){
            google.maps.event.addListener(map, 'idle', function(){
                if( searchClicked != 1 ){
                    ...
                    loadData("assets/external/data2.php", ajaxData);
                    loadData("assets/external/data2a.php", ajaxData);
            ...
            google.maps.event.addListenerOnce(map, 'idle', function(){
                loadData("assets/external/data2.php");
                loadData("assets/external/data2a.php");
      ...
      //  $("[data-ajax-live='location']").on("changed.bs.select", function (e) {
        ...
        $("[data-ajax-response='map']").on("click", function(e){
            ...
            searchClicked = 1;
            if( $(this).attr("data-ajax-auto-zoom") == 14 ){
                mapAutoZoom = 14;
            }
